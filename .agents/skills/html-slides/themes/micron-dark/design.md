...
For practical Micron dark technical or engineering decks, read this file first,
then read `themes/micron-dark-engineering/design.md` for title-template choices,
production-grade dark UI patterns, and approved React Flow / Three.js usage.
