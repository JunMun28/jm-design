...
Use this as the required slide runtime architecture for every theme in the skill.
This skill is self-contained; use bundled files inside `html-slides`.

## Source files to read

- `references/runtime/html-template.md`: canonical architecture template. Start from this structure.
- `references/tokens/viewport-base.css`: paste full contents into output.
- `references/runtime/animation-patterns.md`: use only when motion decisions are needed.
...
- `references/process/export-workflows.md`: use for PDF delivery.
- `references/process/verification.md`: use before final response.
...
Do not invent a different runtime. Adapt bundled `references/runtime/html-template.md` to Micron tokens and layouts.
...
Follow `references/runtime/html-template.md`:
