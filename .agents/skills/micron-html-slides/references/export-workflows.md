...
For `micron-slides.html`:

```bash
bash <skill-dir>/scripts/export-pdf.sh micron-slides.html micron-slides.pdf
```
...
Not supported by this skill. If the user needs editable PowerPoint output, explain that this skill is optimized for single-file HTML/PDF delivery.
